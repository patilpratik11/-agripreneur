...
class ViewRequested extends StatefulWidget {
  ViewRequested(this.grpId);

  final String grpId;

  @override
  _ViewRequestedState createState() => _ViewRequestedState();
}

class _ViewRequestedState extends State<ViewRequested> {
  @override
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: Firestore.instance
            ...
            .where('request_id', arrayContains: widget.grpId)
            .snapshots(),
